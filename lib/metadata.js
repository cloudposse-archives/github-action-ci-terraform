class MetadataHandler {
    ...
    handle() {
        ...
        if (context.payload.pull_request) {
            this.handle_pull_request(inputs, github, core, context);
        } else if (context.payload.issue) {
            this.handle_chatops(inputs, github, core, context);
        }
    }

    handle_pull_request(inputs, github, core, context) {
    ...
    handle_chatops(inputs, github, core, context) {
          // extract the SHA of the commit at the head of the PR
          const prUrl = context.payload.issue.pull_request.url;
          const prDetails = githubClient.request(`GET ${prUrl}`);
