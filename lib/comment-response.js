class CommentResponse {
    ...
    async respond() {
        ...
        if ( (rt !== "" || rr !== "") && (ut === "" && ur === "") ) {
            ...
            commentBodyAddition = commentBodyAddition + "Valid actions: " + "<b>" + rt + " " + rr + "</b>" + "\n";
            ...
            commentBodyAddition = commentBodyAddition + "Invalid actions: " + "<b>" + ut + " " + ur + "</b>" + "\n";
        ...
        console.log("initial comment.body: " + comment.body);
        let commentPreposition = "<b>Original request:</b>" + "\n";
        let commentBody = commentPreposition + comment.body + commentBodyAddition;
        console.log("final commentBody: " + commentBody);
