...
// (Adjust exact path, particularly use of `../`s, according to level of directory nesting in referring action.)
//
// Description:
//
...
class ActionContext {
    ...
    //
    // The function allows you to build incrementally off other variables and do things like
